    ...
    titlePanel("Interactive PCA Explorer"),
        ...
        tabsetPanel(
          ...
          tabPanel("Data input", br(),
                   ...
                   p("Have a look at the ", a("soil.csv", href = "http://test-pecan.bu.edu/shiny/UIUC/Data/soil.csv"),  " file included with this app to see what a clean CSV file looks like."),
                   tags$hr(),
          ...
          tabPanel("Correlation Plots",
                   ...
                   fluidRow(
                     column(8,plotOutput("corr_plot", height = "500px")),
                     column(4,p("Summary of correlations"),tableOutput("corr_tables"))
                   ) ,
                   tags$hr()
          ...
          tabPanel("PC Plots",
                   ...
                   fluidRow(
                     column(4,uiOutput("the_pcs_to_plot_x")),
                     column(4,uiOutput("the_pcs_to_plot_y") )
                   ),
                   tags$hr(),
                   ...
                   fluidRow(
                     column(6,plotOutput("z_plot1", height = 500,
                               brush = brushOpts(
                                 id = "z_plot1Brush",
                                 resetOnNew = TRUE))),
                     column(6,plotOutput("hz_plot1", height = 500))
                   ),
                   tags$hr(),
                   ...
                   fluidRow(
                     column(
                       DT::dataTableOutput(outputId = "brush_info_after_zoom"), width = 8)
                   )
          ), # end  tab 
